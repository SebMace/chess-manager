...
Feature: Register a licensed member of a club
  ...
  Scenario Outline: Register a member with an FFE license
    ...
    And Camille is not yet affiliated for the 2026-2027 season
  ...
  @acceptance
  Scenario: Reject registration of a member without a license
  ...
  Scenario: Reject registration of a member without an FFE identifier
