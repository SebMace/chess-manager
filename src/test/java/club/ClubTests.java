...
class ClubTests {
    ...
    void should_identify_a_club_independently_of_its_name() {
        ...
        Club club = new Club(id, "Orléans", "Orléans");
        assertEquals(id, club.id());
        assertEquals("Orléans", club.name());
        assertEquals(club, new Club(id, "Orléans Échecs", "Orléans"));
        assertNotEquals(club, new Club(new ClubId(UUID.fromString("00000000-0000-0000-0000-000000000003")), "Orléans", "Orléans"));
    }
    @Test
