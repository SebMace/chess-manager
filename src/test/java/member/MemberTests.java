...
class MemberTests {
    ...
    void should_change_the_elo_rating_of_a_member() {
        ...
        Member member = new Member(new MemberId(UUID.randomUUID()),"Sébastien", "Macé");
    ...
    void should_create_a_member_with_an_internal_id_and_without_a_fide_id() {
        ...
        Member member = new Member(memberId, "Anatoly", "Karpov");
    ...
    void should_reject_a_member_without_a_member_id() {
        assertThrows(IllegalArgumentException.class, () -> new Member(null, "Anatoly", "Karpov"));
    }
    // Day 8
    @Test
    ...
    void should_consider_members_with_the_same_member_id_as_the_same_member() {
        ...
        Member member1 = new Member(new MemberId(uuid), "Anatoly", "Karpov");
        Member member2 = new Member(new MemberId(uuid), "Magnus", "Carlsen");
    ...
    void should_consider_homonyms_as_different_members_if_their_identities_are_different () {
        ...
        Member member1 = new Member(memberId1, "Anatoly", "Karpov");
        Member member2 = new Member(memberId2, "Anatoly", "Karpov");
