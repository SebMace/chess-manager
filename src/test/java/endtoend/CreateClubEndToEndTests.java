...
class CreateClubEndToEndTests {
    ...
    void an_administrator_creates_a_club_with_its_information() throws Exception {
        ...
        assertEquals(new PostalAddress("5 rue du Roi", "45100", "Orléans"), club.playingVenue());
    }
    ...
    @Test
    void a_club_cannot_be_created_without_its_playing_venue() throws Exception {
        HttpResponse<Void> response = post("""
                {"name": "Loury Échecs", "committeeCode": "45", "ffeClubId": "G45012", "communeCode": "45188",
                 "registeredOffice": {"street": "3 place de l'Église", "postcode": "45470", "town": "Loury"}}""");
